build/hotedge@jonathan.jdoda.ca.shell-extension.zip : extension.js metadata.json stylesheet.css schemas/org.gnome.shell.extensions.hotedge.gschema.xml schemas/gschemas.compiled
	mkdir -p build
